...
<head>
    ...
    <style>
        * { scrollbar-width: thin; scrollbar-color: #D1DAB7 transparent; }
        ...
        .card-hover.selected { transform: translateY(-3px); box-shadow: 0 0 0 2px #7B8564, 0 12px 25px -8px rgba(123,133,100,0.2); }
        .time-btn { transition: all 0.2s ease; }
        .time-btn:hover:not(:disabled) { transform: translateY(-2px); box-shadow: 0 4px 12px rgba(123,133,100,0.2); }
        .time-btn.selected { transform: translateY(-2px); box-shadow: 0 0 0 2px #7B8564, 0 4px 12px rgba(123,133,100,0.15); }
        .skeleton { background: linear-gradient(90deg, #E8EDDB 25%, #D1DAB7 50%, #E8EDDB 75%); background-size: 200% 100%; animation: shimmer 1.5s infinite; border-radius: 8px; }
                    ...
                    <div class="bg-white/80 dark:bg-stone-800/80 backdrop-blur-md rounded-3xl shadow-xl border border-white/60 dark:border-stone-700/50 p-6 sm:p-8">
                        ...
                        <div id="step1" class="step-content step-enter">
                            ...
                            <div id="step1Welcome" class="hidden mt-6 p-6 bg-gradient-to-r from-emerald-50 to-green-50 dark:from-emerald-900/20 dark:to-green-900/20 rounded-2xl border border-emerald-200 dark:border-emerald-800 text-center">
                                ...
                                <h3 class="text-xl font-bold text-emerald-800 dark:text-emerald-200 mb-1">Bem-vinda, <span id="welcomeName"></span>!</h3>
                        ...
                        <div id="step2" class="step-content hidden">
                            <h2 class="text-lg font-semibold text-stone-800 dark:text-stone-100 mb-1">Escolha a Atendente</h2>
                                ...
                                <div class="professional-card card-hover relative bg-white dark:bg-stone-700 rounded-xl border-2 border-stone-100 dark:border-stone-600 p-4 cursor-pointer" data-value="{{ $u->id }}" onclick="selectProfessional(this)">
                                    <div class="flex items-center gap-3">
                                        ...
                                        <div>
                                            ...
                                            <div class="text-xs text-stone-400 dark:text-stone-500">Atendente</div>
                                        </div>
                                    </div>
                        ...
                        <div id="step4" class="step-content hidden">
                            ...
                            <div class="mt-6 p-4 bg-stone-50 dark:bg-stone-700/50 rounded-xl border border-stone-100 dark:border-stone-600" id="summaryBox">
                                ...
                                <div class="space-y-2 text-sm">
                                    ...
                                    <div class="flex items-center gap-2"><span class="text-stone-400 dark:text-stone-500 w-20 shrink-0">Atendente:</span><span class="font-medium text-stone-800 dark:text-stone-100" id="resumoAtendente">—</span></div>
