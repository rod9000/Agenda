...
@section('header')
    <div class="flex justify-between items-center">
        <h2 class="font-semibold text-xl text-amber-800 leading-tight">Produtos</h2>
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td class="text-right space-x-2">
                            <a href="{{ route('admin.products.edit', $p) }}" class="text-amber-600 hover:text-amber-800 font-medium">Editar</a>
                    ...
                    @empty
                    <tr><td colspan="5" class="px-4 py-8 text-center text-amber-400">Nenhum produto cadastrado.</td></tr>
                    @endforelse
                </tbody>
            </table>
