...
class WhatsAppService
{
    ...
    public function sendConfirmation($appointment): bool
    {
    ...
    public function sendCancellation($appointment): bool
    {
        $appointment->load('services', 'customer');

        $serviceList = $appointment->services->pluck('name')->implode(', ');
        $rescheduleLink = url('/agendar');
    ...
    public function sendReminder($appointment): bool
    {
        $appointment->load('services', 'customer');
